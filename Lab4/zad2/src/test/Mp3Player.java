...
public interface Mp3Player {
	...
	/**
	 * Rozpocznij odtwarzanie od utworu znajdujacego sie na szczycie listy
	 * utworow lub nie rob nic gdy lista jest pusta.
	 */
	public void play();

	/**
	 * Wstrzymaj odtwarzanie. Odtwarzanie bedzie pozniej wznowione od tego
	 * miejsca.
	 */
	public void pause();

	/**
	 * Zatrzymaj odtwarzanie. Biezacy utwor pozostaje na szczycie listy, ale
	 * odtwarzanie zostanie wznowione od jego poczatku.
	 */
	public void stop();
